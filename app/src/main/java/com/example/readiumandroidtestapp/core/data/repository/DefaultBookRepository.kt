...
class DefaultBookRepository @Inject constructor(
     ...
     *
     * @return [Try.Success] with the imported [Book], or [Try.Failure] with an [com.example.readiumandroidtestapp.core.data.book.ImportError] (Network, Storage, etc.).
     */
     ...
     * @param locator The JSON string representation of the [Locator].
     *
     ...
     * @param locator The [Locator] of the bookmark.
     *
